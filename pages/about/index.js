        ...
        <div className = 'container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
          <div className = 'flex flex-1 flex-col justify-center'>
            <motion.h2 className = 'h2'
                       ...
                       exit = 'hidden'
            >
              Captivating <span className = 'md:text-accent'>stories</span> birth magnificent <span className = 'md:text-white text-accent'>designs.</span>
            </motion.h2>
          ...
          <motion.div className = 'flex flex-col w-full xl:max-w-[50%] h-[480px]'
                ...
                return (
                    <div key = {itemIndex}
                         className = {`${index === itemIndex && 'text-accent after:w-[100%] after:bg-accent after:transition-all  after:duration-300'}
                                      ...
                                      after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-2 after:left-0`}
